...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Disable touch until the swipe menu view controller slide animation is finished.  Fixes a display bug if you selected a left menu
    // tableview item too often.
