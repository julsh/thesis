...
- (void)checkInputs {
	...
	regEx = @"[A-Za-z0-9._!\\?@-]{5,18}$";
	testPredicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", regEx];
	if (![testPredicate evaluateWithObject:inputToEvaluate]) {
		errorMessage = [errorMessage stringByAppendingString:@"The password must contain 5 to 18 characters. Valid characters are letters, digits and any of the following special characters:\n _ - . ! ? @\n\n"];
	}
