...
- (void)viewDidAppear:(BOOL)animated {
	...
	// make sure that the menu is available for every instance of this class
...
- (void)switchToViewControllerWithClassName:(NSString *)className {
	...
	if (self.mainViewController.presentedViewController) {
		// if the current view controller is presented modally, we're re-using this one to carry on
